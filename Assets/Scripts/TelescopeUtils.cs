...
namespace Telescopes
{
    public class TelescopeUtils
    {
        ...
        public static void growParentToChild(TelescopeParameters parent, TelescopeParameters child)
        {
            ...
            float finalRadius = Mathf.Max(Mathf.Max(innerDiff, outerDiff) + parent.thickness, parent.radius);
